...
linear_proposed = [-27.69, -27.74, -28.11, -28.36, -28.49, -28.53, -28.53]
...
excel_filename = "/workspaces/MIMO_Channel_Estimation_Deep_Learning_CURIN/Batch_Size/Results/new_comparison_nmse_vs_snr_batch_size64.xlsx"
...
plt.xlabel("SNR (dB)")
plt.ylabel("NMSE (dB)")
plt.title("NMSE vs SNR for Batch Size 64 (Model Comparison)")
plt.legend()
plt.grid(True)

# Save the graph
graph_filename = "/workspaces/MIMO_Channel_Estimation_Deep_Learning_CURIN/Batch_Size/Results/new_comparison_nmse_vs_snr_batch_size64.png"
...
# snr_values = [-10, -5, 0, 5, 10, 15, 20]
# linear_proposed = [-55.38, -55.48, -56.21, -56.73, -56.96, -57.03, -57.08]
