...
def train_model(model, X_train, y_train, X_val, y_val, model_name='model', save_folder='/workspaces/final-code/Parameters_change/SNR_Iterations/Trained_Models'):

    # Paths for saving model weights and final model
...
if __name__ == "__main__":
    ...
    noise_factor = 0.5
    save_folder = "/workspaces/final-code/Parameters_change/SNR_Iterations/Trained_Models"

    for snr in snr_values:
        print(f"\nTraining models for SNR = {snr} dB")

        dataset_folder = "/workspaces/final-code/Parameters_change/SNR_Iterations/Generated_Data"
        dataset_path = os.path.join(dataset_folder, f'thz_mimo_dataset_snr_{snr}.npz')
